...
public class PlayerJumpState : State
{
    ...
    public PlayerJumpState(StateMachine stateMaschine) : base(stateMaschine) { }
    ...
    public override void Enter(params object[] args)
    {
        ...
        // determine if jump buffering was successful, then increase jump height
        player.Velocity.y = args.Length != 0 ? -player.MaxJumpHeight * player.JumpBufferHeightBonus : -player.MaxJumpHeight;
        player.AnimatedSprite.Play("jump");
